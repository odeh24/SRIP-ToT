...
void loop() {
  ...
  pkt.value1 = map(flex1, 0, 300, 0, 255); //maps them to PWM scale
  pkt.value2 = map(flex2, 0, 600, 0, 255); 
  pkt.value3 = map(flex3, 0, 600, 0, 255);
  pkt.value4 = map(flex4, 0, 600, 0, 255); 
  pkt.value5 = map(flex5, 0, 600, 0, 255);
